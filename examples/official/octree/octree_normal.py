...
# }
# 
points = np.zeros((10000, 3), dtype=np.float32)
RAND_MAX = 10024.0
...
normals = np.zeros((10000, 4), dtype=np.float32)
RAND_MAX = 10024.0
for i in range(0, 10000):
    normals[i][0] = 1024 * random.random () / RAND_MAX
    normals[i][1] = 1024 * random.random () / RAND_MAX
    normals[i][2] = 1024 * random.random () / RAND_MAX
    normals[i][3] = 1024 * random.random () / RAND_MAX
normal.from_array(normals);
...
octree.enable_dynamic_depth(150)
